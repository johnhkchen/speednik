"""tests/harness.py — Scenario runner and strategy primitives for robotic player testing.

Provides a Pyxel-free simulation loop that feeds inputs frame-by-frame via a strategy
function and returns a trajectory log. Imported by test files, not a test file itself.
"""
